...
public class Appointment_info {
    ...
    public Appointment_info(String date, String doctor_id, String problem, String user_id, String doctor_name, String hospital_id,String hospital_name) {
        this.date = date;
    ...
    public Appointment_info(String date, String doctor_id, String problem, String user_id, String doctor_name, String hospital_id, String hospital_name, String patient_name, String patient_contactNum) {
        this.date = date;
        this.doctor_id = doctor_id;
        this.problem = problem;
        this.user_id = user_id;
